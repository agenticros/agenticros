...
| Published packages | `@agenticros/core` **0.8.9**, CLI `agenticros` **0.7.21** |
...
| Window | Focus |
|--------|--------|
| **Now** | ARC orgs + teams live on Teams / Enterprise; OSS safety/profile ABI on core 0.8.9 / CLI 0.7.21 |
